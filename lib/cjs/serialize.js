...
var BorshSerializer = /** @class */ (function () {
    ...
    BorshSerializer.prototype.encode_value = function (value, schema) {
        if (typeof schema === 'string') {
            ...
            if (schema === 'publicKey')
                return this.encode_publicKey(value);
            if (schema === 'bytes')
                return this.encode_bytes(value);
        }
        if (typeof schema === 'object') {
            ...
            if ('vec' in schema)
                return this.encode_vec(value, schema);
            if ('set' in schema)
    ...
    BorshSerializer.prototype.encode_publicKey = function (value) {
        this.checkTypes && utils.expect_type(value, 'string', this.fieldPath);
        var _value = new web3_js_1.PublicKey(value);
        this.encoded.store_bytes(_value.toBytes());
    };
    BorshSerializer.prototype.encode_bytes = function (value) {
        if (!(value instanceof Uint8Array) && !(Array.isArray(value))) {
            throw new Error("Expected Uint8Array or Array not ".concat(typeof (value), "(").concat(value, ") at ").concat(this.fieldPath.join('.')));
        }
        var _value = value instanceof Uint8Array ? value : new Uint8Array(value);
    ...
    BorshSerializer.prototype.encode_vec = function (value, schema) {
        if (!utils.isArrayLike(value)) {
            throw new Error("Expected Array-like not ".concat(typeof (value), "(").concat(value, ") at ").concat(this.fieldPath.join('.')));
        }
        var _value = value;
