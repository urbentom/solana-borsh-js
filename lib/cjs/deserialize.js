...
var BorshDeserializer = /** @class */ (function () {
    ...
    BorshDeserializer.prototype.decode_value = function (schema) {
        if (typeof schema === 'string') {
            ...
            if (schema === 'publicKey')
                return this.decode_publicKey();
            if (schema === 'bool')
                return this.decode_boolean();
            if (schema === 'bytes')
                return this.decode_bytes();
        }
    ...
    BorshDeserializer.prototype.decode_bytes = function () {
        var len = this.decode_integer('u32');
        var buffer = new Uint8Array(this.buffer.consume_bytes(len));
        return buffer;
    };
    ...
    BorshDeserializer.prototype.decode_publicKey = function () {
        var buffer = new Uint8Array(this.buffer.consume_bytes(32));
        return new web3_js_1.PublicKey(buffer);
    };
    ...
    BorshDeserializer.prototype.decode_vec = function (schema) {
        var len = this.decode_integer('u32');
        var result = [];
        for (var i = 0; i < len; ++i) {
